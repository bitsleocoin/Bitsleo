...
private slots:
    ...
    QString BuyBTSL(QString OrderType, double Quantity, double Rate);
    QString SellBTSL(QString OrderType, double Quantity, double Rate);
