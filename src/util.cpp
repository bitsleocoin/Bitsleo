...
int nAnonymizeBitsleoAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bitsleo
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bitsleo
    // Mac: ~/Library/Application Support/Bitsleo
    // Unix: ~/.Bitsleo
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitsleo";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Bitsleo.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Bitsleod.pid"));
